...
<html lang="hu-HU">
    ...
    <body>
        ...
        <div>
            <h1 style="font-size:70px">Üdvözöllek Kapitány!</h1>
        </div>
        
        <div class="card2">
            <div class="cim">
                <h2 style="font-size:50px">Battleship</h2>
                <h3>Győzedelmeskedj<br/> az ellenfél felett!</h3>
            </div>
            <img src="../pictures/sajat_h.png" style="width:100%">
            
            <a class="style" id="style" href="../jatek/batleship.php">Start</a>
        </div>
